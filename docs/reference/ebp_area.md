...
#> (Intercept)  3.04292199  0.69337407  4.38857193  0.00001141  1.69553602
#> x1          -0.00117774  0.00880611 -0.13374100  0.89360739 -0.01878321
#> x2           0.05166274  0.05557959  0.92952721  0.35261593 -0.05677071
#> x3           0.03775970  0.05272546  0.71615681  0.47389453 -0.06709180
#>             ci_upper
#> (Intercept)   4.4274
#> x1            0.0160
#> x2            0.1621
...
#> 1      1 8.359527 7.346442    7.346442 0.7431487 0.5522699 10.11576 5.909853
#> 2      2 7.599650 6.505007    6.505007 0.8038195 0.6461258 12.35693 4.956221
#> 3      3 5.514137 5.053747    5.053747 0.7980956 0.6369566 15.79216 3.502535
#> 4      4 3.869326 4.302289    4.302289 0.7107163 0.5051177 16.51949 2.898603
#> 5      5 6.305063 6.322332    6.322332 0.8821471 0.7781834 13.95287 4.589882
#> 6      6 3.926807 4.084927    4.084927 0.5731442 0.3284943 14.03071 2.958640
#>   ci_upper random_effect    vardir
#> 1 8.822784    2.67522497 0.6618838
#> 2 8.107569    2.29153368 0.8374691
#> 3 6.634326    0.90446630 0.8822257
#> 4 5.687251   -1.16083746 0.6581716
#> 5 8.055279   -0.02614543 1.2788021
#> 6 5.206914   -0.72015710 0.3878004
#> ... and 36 more rows.
#> 
#> 
#> ── Fast Small Area Estimation (fastsae) ────────────────────────────────────────
...
#> Random effect variance (sigma2_u): 1.666586 
#> Spatial autocorrelation (rho): 0.4817 
#> Spatial mixing fraction (phi): 0.4817 
#> 
#> Fixed Effects Coefficients:
#>                    beta   std.error      zvalue      pvalue    ci_lower
#> (Intercept)  3.0436e+00  6.7544e-01  4.5061e+00  6.6019e-06  1.7297e+00
#> x1          -1.1808e-03  8.7846e-03 -1.3441e-01  8.9307e-01 -1.8692e-02
#> x2           5.1685e-02  5.5473e-02  9.3170e-01  3.5149e-01 -5.6612e-02
#> x3           3.7716e-02  5.2623e-02  7.1673e-01  4.7354e-01 -6.6715e-02
#>             ci_upper
#> (Intercept)   4.3884
#> x1            0.0159
#> x2            0.1617
...
#> EBP Estimates (First 6 domains):
#>   domain        y      ebp linear_pred        sd       mse      rse ci_lower
#> 1      1 8.359527 7.348451    7.348451 0.7396436 0.5470726 10.06530 5.914565
#> 2      2 7.599650 6.506833    6.506833 0.8002599 0.6404159 12.29876 4.960604
#> 3      3 5.514137 5.054914    5.054914 0.7974587 0.6359404 15.77591 3.503530
#> 4      4 3.869326 4.301760    4.301760 0.7103527 0.5046009 16.51307 2.899915
#> 5      5 6.305063 6.322403    6.322403 0.8823344 0.7785140 13.95568 4.589818
#> 6      6 3.926807 4.084747    4.084747 0.5731866 0.3285429 14.03237 2.958614
#>   ci_upper random_effect    vardir
#> 1 8.814049    2.67923399 0.6618838
#> 2 8.097859    2.29512658 0.8374691
#> 3 6.632321    0.90611398 0.8822257
#> 4 5.686884   -1.16244717 0.6581716
#> 5 8.055440   -0.02604913 1.2788021
#> 6 5.207002   -0.72118160 0.3878004
#> ... and 36 more rows.
#> 
# }
```
